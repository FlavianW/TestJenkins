        ...
        stage('Clone Git Repository') {
            steps {
                script {
                    ...
                    bat 'plink -ssh -batch -autoStoreKey root@127.0.0.1 -pw AZER -P 42 "rm -rf /var/www/* && mkdir /var/www/html && git clone https://github.com/FlavianW/TestJenkins.git /var/www/html/"'
                }
            }
        }
    }
